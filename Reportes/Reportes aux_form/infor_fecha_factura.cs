...
{
    public partial class infor_fecha_factura : Form
    {
        public infor_fecha_factura()
        {
            InitializeComponent();
        }

        private void infor_fecha_factura_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(txt_patron.Text))
            {
                ...
                {
                    sql += " AND n_factura = " + txt_patron.Text;
                }
                else
                {
                    if (txt_patron.Text.IndexOf("-") != -1)
                    {
                        ...
                        sql += @" AND n_factura BETWEEN " + datos[0]
                            + " AND " + datos[1];
                    }
                    else
                    {
