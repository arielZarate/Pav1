...
{
    public partial class info_huesped_hotel : Form
    {
        public info_huesped_hotel()
        {
            InitializeComponent();
        }

        private void info_huesped_hotel_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(txt_patron.Text))
            {
                ...
                {
                    sql += " AND id_hotel = " + txt_patron.Text;
                }
                else
                {
                    if (txt_patron.Text.IndexOf("-") != -1)
                    {
                        ...
                        sql += @" AND id_hotel BETWEEN " + datos[0]
                            + " AND " + datos[1];
                    }
                    else
                    {
